...
<head>
    ...
    <style>
        .imagen-container {
            ...
            background: url('compromiso2.PNG') no-repeat center center;
...
<h1 class="titulo_principal">HOSPITAL MILITAR DE MEDELLÍN (HOMME)</h1>
    ...
    <form action="login3.php" method="post" class="form-register">
        <h2 class="form__titlo">Inicio de sesión</h2>
        <div class="contenedor-inputs">
            <input type="text" name="usuario" placeholder="usuario" class="input-48" required>
            <input type="password" name="contraseña" placeholder="contraseña" class="input-100" required><br>
